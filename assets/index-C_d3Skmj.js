...
`,m=()=>{const t=e();function e(){return JSON.parse(localStorage.getItem("user"))!==null}const o=window.location.pathname,s=window.location.hash;return console.log(o),console.log(s),console.log("production"),console.log("production"),`
    <div class="max-w-md w-full">
        ...
        <nav class="bg-white shadow-md p-2 sticky top-14">
          <ul class="flex justify-around">
            <li><a href="/" class="${o==="/"||s=="#/"?"text-blue-600 font-bold":"text-gray-600"}">홈1</a></li>
            </li>
