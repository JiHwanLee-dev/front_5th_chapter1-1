        ...
        <nav class="bg-white shadow-md p-2 sticky top-14">
          <ul class="flex justify-around">
            ...
            ${t?`<li><a href="/profile" class="${e===d||n=="#/profile"?"text-blue-600 font-bold":"text-gray-600"}">프로필</a></li>
                <li><a href="/login" id='logout' class="${e===b||n=="#/login"?"text-blue-600 font-bold":"text-gray-600"}">로그아웃</a></li>
              `:`<li><a href="/login" class="${e===l+"/login"||n=="#/login"?"text-blue-600 font-bold":"text-gray-600"}">로그인</a></li>`}
          </ul>
        </nav>
  `},h=()=>`
...
`,$=()=>`
  ...
  `};console.log("나는 router.js야");const r={getCurrentPath:()=>(console.log("getCurrentPath"),console.log(window.location.pathname),window.location.pathname.includes("index.hash.html")||window.location.hash!==""?window.location.hash.slice(1)||"/":window.location.pathname),navigate:t=>{console.log("router - navigate"),window.location.pathname.includes("index.hash.html")||window.location.hash!==""?window.location.hash=t:window.history.pushState({},"",t)}},L=!0,c="/front_5th_chapter1-1";console.log(`isProduction: ${L}`);const v={[`${c}/`]:y,[`${c}/login`]:$,[`${c}/profile`]:S},f=t=>(console.log(`Redirecting to ${t}`),r.navigate(t),v[t]()),P=t=>{console.log("routes - handleRouting"),console.log(`path: ${t}`);const o=JSON.parse(localStorage.getItem("user"));let e;if(o===null&&t==="/profile")return console.log("Unauthorized access to profile, redirecting to login"),f("/login");if(o!==null&&t==="/login")return console.log("Already logged in, redirecting to home"),f("/");if(e=v[t],e)return e()};console.log(r.getCurrentPath());const u="/front_5th_chapter1-1";function g(t){r.navigate(t),m()}function E(){localStorage.clear()}window.addEventListener("popstate",()=>{m()});const m=()=>{console.log("main.js redner start");const t=r.getCurrentPath();console.log(t);const o=P(t);o===void 0?document.getElementById("root").innerHTML=`${w()}`:document.getElementById("root").innerHTML=o};m();document.body.addEventListener("click",t=>{if(console.log("addEventListener click"),t.target.type!=="submit"){if(t.preventDefault(),(t.target.closest("nav")||t.target.closest("a"))&&t.target.href!==void 0){const o=new URL(t.target.href),e=o.pathname;console.log(`url: ${o}`),console.log(`path: ${e}`),t.target.id==="logout"&&E(),t.target.tagName==="A"&&document.querySelectorAll("nav ul li a").forEach(l=>{l.classList.add("bg-blue")}),g(u+e)}console.log("addEventListener click End")}});document.body.addEventListener("submit",t=>{if(t.preventDefault(),t.target.id==="login-form"){const o=new FormData(t.target),e={};e.username=o.get("username"),e.email="",e.bio="",localStorage.setItem("user",JSON.stringify(e)),g(`${u}/profile`)}else if(t.target.id==="profile-form"){const o=JSON.parse(localStorage.getItem("user")),e=new FormData(t.target);e&&(o.email=e.get("email"),o.bio=e.get("bio")),localStorage.setItem("user",JSON.stringify(o)),alert("프로필 정보가 수정되었습니다. "),g(`${u}/profile`)}});
