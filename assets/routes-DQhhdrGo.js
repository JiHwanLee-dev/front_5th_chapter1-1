...
`,p=()=>{const e=l();function l(){return JSON.parse(localStorage.getItem("user"))!==null}const o=window.location.pathname,n=window.location.hash,t="/front_5th_chapter1-1";let s="/",a="/profile",g="/login",r,d,c;return r=t+s,d=t+a,c=t+g,console.log(o+" | "+r),console.log(o+" | "+d),`
...
`,x=()=>`
  ...
  `};console.log("나는 router.js야");const u="/front_5th_chapter1-1",w={getCurrentPath:()=>{console.log("start getCurrentPath");const e=window.location.pathname.includes("index.hash.html")||window.location.hash!=="";return e?e?u+window.location.hash.slice(1)||u+"/":window.location.pathname:e?window.location.hash.slice(1)||"/":window.location.pathname},navigate:e=>{window.location.pathname.includes("index.hash.html")||window.location.hash!==""?window.location.hash=e:window.history.pushState({},"",e)}},i="/front_5th_chapter1-1",f={[`${i}/`]:h,[`${i}/login`]:x,[`${i}/profile`]:v},b=e=>(console.log(`Redirecting to ${e}`),w.navigate(e),f[e]()),P=e=>{console.log("routes - handleRouting");const l=JSON.parse(localStorage.getItem("user"));let o;if(l===null&&e==="/profile")return console.log("Unauthorized access to profile, redirecting to login"),b(`${i}/login`);if(l!==null&&e==="/login")return console.log("Already logged in, redirecting to home"),b(`${i}/login`);if(o=f[e],o)return o()};export{$ as E,P as h,w as r};
